...
# Calculate the Total Amount by Client Segment
    ...
    with cls2:
            ...
            # Display the chart in Streamlit
            st.markdown('<h3 class="custom-subheader">Top 15 Popular Service Providers by Visit Amount</h3>', unsafe_allow_html=True)
            st.plotly_chart(fig, use_container_width=True)
    ...
    with cls1:
            ...
            # Display the chart in Streamlit
            st.markdown('<h3 class="custom-subheader">Top 15 Clients by Visit Amount</h3>', unsafe_allow_html=True)
            st.plotly_chart(fig, use_container_width=True)
